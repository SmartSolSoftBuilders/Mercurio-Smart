...
<html>
    <head>
        <title>Cargar archivo para cambio de estatus de pago de pólizas</title>
        ...
        <script language="JavaScript" type="text/javascript"> 
            ...
            function verDetalle(id){
            	document.location.href = 
            		'<c:url value="/app/consultarArchivoCambioEstatusPagosPolizaController"/>?idArchivosCambioEstatusPagos='+id;
            }
    ...
    <body >
     <jsp:include page="/jsp/menu.jsp"></jsp:include>
    				<br/><br/> 
        <form action="cargaArchivoCambioEstatusPagosPolizaController" method="POST"  enctype="multipart/form-data" id="formulario" onsubmit="return valida()">
	        ...
	        <div id="titleg664x16">Cargar Archivo Para el Cambio de Estatus de Pagos de P&oacute;liza</div>
	               
	             
	                
	                    <div align="center" class="submit664">
	                   	Descargar Archivo de Muestra de Formato: 
	                   		<a href="<c:url value="/formatos/CambioEstatusPago.xls"/>">Cambio de Estatus de Pago</a> 
	                    </div>
            	 	...
            	 	<table width="600" border="0" cellpadding="5" cellspacing="1">
                          <tr>
                            <td align="center" class="ContenTablaColor"><strong>
                                No existen archivo de cambio de estatus de pago de p&oacute;liza cargados todav&iacute;a.
                                </strong>
                           </td>
                        ...
                        <c:forEach items="${listaArchivosCambioEstatus}"  var="resumen">
                        	<tr align="left" valign="middle">
                                        <td align="center" width="4%" class="ContenTabla">
	                                        <a href="javascript:verDetalle('${resumen.idArchivoCambioEstatusPagosPoliza}')" title="Detalle">
