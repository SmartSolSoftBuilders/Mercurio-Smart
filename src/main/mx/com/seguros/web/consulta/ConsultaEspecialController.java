...
import mx.com.seguros.business.consulta.IConsultaEspecialBusiness;
...
/**
 * Controller que atiende las solicitudes de consulta de solicitudes especiales
 * @author Fernando López
 */
public class ConsultaEspecialController extends SimpleFormController{
    private Integer registrosPorPagina;

    private IConsultaEspecialBusiness consultaEspecialBusiness;
    ...
    public ModelAndView onSubmit(HttpServletRequest request,HttpServletResponse response,
        ...
        System.out.println("resultado "+resultado.getResultados());
        
        criterios.setIdPlaza(seguridadUtil.getEmpleado().getIdPlaza());
        System.out.println("idplaza: "+seguridadUtil.getEmpleado().getIdPlaza());
        consultaEspecialBusiness.consultarSolicitudesEsp(criterios, resultado);
    ...
    /**
     * @return the consultaEspecialudesBusiness
     */
    public IConsultaEspecialBusiness getConsultaEspecialBusiness() {
        return consultaEspecialBusiness;
    }

    /**
     * @param consultaEspecialBusiness the consultaEspecialBusiness to set
     */
    public void setConsultaEspecialBusiness(IConsultaEspecialBusiness consultaEspecialBusiness) {
        this.consultaEspecialBusiness = consultaEspecialBusiness;
    }
