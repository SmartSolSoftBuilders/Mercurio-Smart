...
/**
 * DTO que representa un registro de la tabla de ArchivoCambioEstatusPagosPoliza
 * @author Emigdio Hernandez
 *
 */
public class ArchivoCambioEstatusPagosPoliza implements Serializable{
	 ...
	 */
	private Integer idArchivoCambioEstatusPagosPoliza;
	/**
	...
	/**
	 * @return the idArchivoCambioEstatusPagosPoliza
	 */
	public Integer getIdArchivoCambioEstatusPagosPoliza() {
		return idArchivoCambioEstatusPagosPoliza;
	}
	/**
	 * @param idArchivoCambioEstatusPagosPoliza the idArchivoCambioEstatusPagosPoliza to set
	 */
	public void setIdArchivoCambioEstatusPagosPoliza(
			Integer idArchivoCambioEstatusPagosPoliza) {
		this.idArchivoCambioEstatusPagosPoliza = idArchivoCambioEstatusPagosPoliza;
	}
	/**
