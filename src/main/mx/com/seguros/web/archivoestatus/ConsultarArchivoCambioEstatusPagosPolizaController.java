 ...
 * cambio de estatus de pagos pólizas
 * @author Emigdio Hernandez
 *
 */
public class ConsultarArchivoCambioEstatusPagosPolizaController extends AbstractController {
	...
	protected ModelAndView handleRequestInternal(HttpServletRequest request,
		...
		String idArchivo = request.getParameter("idArchivosCambioEstatusPagos");
		
		ArchivoCambioEstatusPagosPoliza archivo = archivoCambioEstatusPolizaBusiness.obtenerArchivosCambioEstatusPagosPolizaPorId(NumberUtils.toInt(idArchivo));
